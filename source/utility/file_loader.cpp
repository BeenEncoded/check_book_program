...
namespace utility
{
	template void                            save      <data::account_data>(data::account_data& t, const boost::filesystem::path& folder);
	template std::set<ID_T>                  ids       <data::account_data>(const boost::filesystem::path& folder);
	template std::vector<data::account_data> load_all  <data::account_data>(const boost::filesystem::path& folder);
	template void                            remove    <data::account_data>(const ID_T& id, const boost::filesystem::path& folder);
	template data::account_data              load      <data::account_data>(const ID_T& id, const boost::filesystem::path& folder);
	template std::vector<data::account_data> load_basic<data::account_data>(const boost::filesystem::path& folder);
